...
public class EditKey extends MenuHolder {
    ...
    public MenuButton getButtonAt(int slot) {
        ...
        return new MenuButton() {
            ...
            public ItemStack getItem() {
                ...
                return containerDataCache.write(containerData, containerBuilder -> {
                    KeysData keysData = containerBuilder.getKeysData(keyName);
    ...
    public boolean run(MenuButtonData button, ClickType click) {
        ...
        if (button.isActionTypeEqual("Change_amount")) {
            containerDataCache.write(containerData, containerBuilder -> {
                KeysData keysData = containerBuilder.getKeysData(keyName);
                ...
                keysData.setAmountNeeded(finalAmountCached);
            });
            return true;
        }
        if (button.isActionTypeEqual("Alter_display_name")) {
